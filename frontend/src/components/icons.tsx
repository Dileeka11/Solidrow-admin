  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path
        ...
        opacity="0.85"
      />
      <path d="M14 3v5h5" stroke="var(--panel)" strokeWidth="1.6" fill="none" strokeLinejoin="round" />
      <path d="M9 13v4M12 11v6M15 14v3" stroke="var(--panel)" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
